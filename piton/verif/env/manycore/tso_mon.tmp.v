...
`ifdef RTL_SPARC4
`ifndef RTL_SPU
wire       spc4_dfq_byp_ff_en      = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
wire       spc4_dfq_wr_en          = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_wr_en;
`else
...
`ifdef RTL_SPARC5
`ifndef RTL_SPU
wire       spc5_dfq_byp_ff_en      = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
wire       spc5_dfq_wr_en          = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_wr_en;
`else
...
`ifdef RTL_SPARC6
`ifndef RTL_SPU
wire       spc6_dfq_byp_ff_en      = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
wire       spc6_dfq_wr_en          = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_wr_en;
`else
...
`ifdef RTL_SPARC7
`ifndef RTL_SPU
wire       spc7_dfq_byp_ff_en      = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
wire       spc7_dfq_wr_en          = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_wr_en;
`else
...
`ifdef RTL_SPARC8
`ifndef RTL_SPU
wire       spc8_dfq_byp_ff_en      = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
wire       spc8_dfq_wr_en          = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_wr_en;
`else
wire       spc8_dfq_byp_ff_en      = `SPARC_CORE8.sparc0.lsu.qctl2.dfq_byp_ff_en;
wire       spc8_dfq_wr_en          = `SPARC_CORE8.sparc0.lsu.qctl2.dfq_wr_en;
`endif
reg        spc8_dfq_byp_ff_en_d1;
reg        spc8_dfq_wr_en_d1;
`endif
...
`ifdef RTL_SPARC8
   wire  [4:0] 		  spc8_pcx_req_pq 	= `SPARC_CORE8.spc0_pcx_req_pq[4:0];
   wire        		  spc8_pcx_atom_pq	= `SPARC_CORE8.spc0_pcx_atom_pq;
   wire  [`PCX_WIDTH-1:0] spc8_pcx_data_pa 	= `SPARC_CORE8.spc0_pcx_data_pa[`PCX_WIDTH-1:0];

   reg 			  pcx8_vld_d1;	// valid pcx packet
   reg 			  pcx8_atom_pq_d1;	// atomic bit delayed by 1
   reg 			  pcx8_atom_pq_d2;	// delayed by 2
   reg 			  pcx8_req_pq_d1;	// OR of request bits delayed by 1
   reg [5:0]		  pcx8_type_d1;	// packet type delayed by 1
`endif
...
`ifdef RTL_SPARC8
   wire                  cpx_spc8_data_vld 	= `SPARC_CORE8.cpx_spc0_data_cx2[`CPX_WIDTH-1];
   wire [`CPX_WIDTH-1:0] cpx_spc8_data_cx2	= `SPARC_CORE8.cpx_spc0_data_cx2[`CPX_WIDTH-1:0];

   reg [`CPX_WIDTH-1:0] cpx_spc8_data_cx2_d1;	// packet delayed by 1
   reg [`CPX_WIDTH-1:0] cpx_spc8_data_cx2_d2;	// packet delayed by 2
   reg [127:0]		spc8_pcx_type_str;		// packet type in string format for debug.

   reg [127:0]		cpx_spc8_type_str;		// in string format for debug

   wire [3:0]  		cpx_spc8_type     	= cpx_spc8_data_vld ? cpx_spc8_data_cx2[`CPX_RQ_HI:`CPX_RQ_LO] :4'h0;
   wire        		cpx_spc8_wyvld    	= cpx_spc8_data_cx2[`CPX_WYVLD] & cpx_spc8_data_vld;

   wire cpx_spc8_st_ack = (cpx_spc8_type == `ST_ACK) | (cpx_spc8_type == `STRST_ACK);
   wire cpx_spc8_evict  = (cpx_spc8_type == `EVICT_REQ);

   reg cpx_spc8_ifill_wyvld;
   reg cpx_spc8_dfill_wyvld;

  wire cpx_spc8_st_ack_dc_inval_1c_tmp = (cpx_spc8_data_cx2[122:121] == 2'b00) ?  cpx_spc8_data_cx2[0]  :
                                          (cpx_spc8_data_cx2[122:121] == 2'b01)   ?  cpx_spc8_data_cx2[32] :
                                          (cpx_spc8_data_cx2[122:121] == 2'b10)   ?  cpx_spc8_data_cx2[56] :
                                          					        cpx_spc8_data_cx2[88];

  wire [2:0] cpx_spc8_st_ack_dc_inval_1c = {2'b00, cpx_spc8_st_ack & cpx_spc8_st_ack_dc_inval_1c_tmp};

  wire cpx_spc8_st_ack_ic_inval_1c_tmp = cpx_spc8_data_cx2[122] ?  cpx_spc8_data_cx2[57] : cpx_spc8_data_cx2[1];
  wire [2:0] cpx_spc8_st_ack_ic_inval_1c = {2'b00, (cpx_spc8_st_ack & cpx_spc8_st_ack_ic_inval_1c_tmp)};
  wire [5:0] cpx_spc8_st_ack_icdc_inval_1c = {6{cpx_spc8_st_ack}} &
					        {cpx_spc8_st_ack_ic_inval_1c, cpx_spc8_st_ack_dc_inval_1c};

  wire [2:0] cpx_spc8_evict_dc_inval_1c   = cpx_spc8_data_cx2[0]  + cpx_spc8_data_cx2[32] +
                                       cpx_spc8_data_cx2[56] + cpx_spc8_data_cx2[88];
  wire [1:0] cpx_spc8_evict_ic_inval_1c   = cpx_spc8_data_cx2[1]  + cpx_spc8_data_cx2[57];


  reg cpx_spc8_evict_d1;
  always @(posedge clk)
    cpx_spc8_evict_d1 <= cpx_spc8_evict;

  wire cpx_spc8_b2b_evict = cpx_spc8_evict_d1 & cpx_spc8_evict;

  wire [5:0] cpx_spc8_evict_icdc_inval_1c;
  assign cpx_spc8_evict_icdc_inval_1c[4:0]={5{cpx_spc8_evict}} &
                                              {cpx_spc8_evict_ic_inval_1c,cpx_spc8_evict_dc_inval_1c};

  assign cpx_spc8_evict_icdc_inval_1c[5] = cpx_spc8_b2b_evict;

  wire [5:0] cpx_spc8_st_ack_dc_inval_8c_tmp = (cpx_spc8_data_cx2[122:121] == 2'b00) ? (
									     cpx_spc8_data_cx2[0] + cpx_spc8_data_cx2[4]   +
									     cpx_spc8_data_cx2[8] + cpx_spc8_data_cx2[12]  +
									     cpx_spc8_data_cx2[16] + cpx_spc8_data_cx2[20] +
									     cpx_spc8_data_cx2[24] + cpx_spc8_data_cx2[28]
                                                                           ) :
                                  (cpx_spc8_data_cx2[122:121] == 2'b01) ? (
									     cpx_spc8_data_cx2[32] + cpx_spc8_data_cx2[35] +
									     cpx_spc8_data_cx2[38] + cpx_spc8_data_cx2[41] +
									     cpx_spc8_data_cx2[44] + cpx_spc8_data_cx2[47] +
									     cpx_spc8_data_cx2[50] + cpx_spc8_data_cx2[53]
                                                                           ) :
                                  (cpx_spc8_data_cx2[122:121] == 2'b10) ? (
									     cpx_spc8_data_cx2[56] + cpx_spc8_data_cx2[60] +
									     cpx_spc8_data_cx2[64] + cpx_spc8_data_cx2[68] +
									     cpx_spc8_data_cx2[72] + cpx_spc8_data_cx2[76] +
									     cpx_spc8_data_cx2[80] + cpx_spc8_data_cx2[84]
                                                                           ) :
									   ( cpx_spc8_data_cx2[88] + cpx_spc8_data_cx2[91] +
									     cpx_spc8_data_cx2[94] + cpx_spc8_data_cx2[97] +
									     cpx_spc8_data_cx2[100]+ cpx_spc8_data_cx2[103]+
									     cpx_spc8_data_cx2[106]+ cpx_spc8_data_cx2[109]
                                                                           ) ;

  wire [5:0] cpx_spc8_st_ack_dc_inval_8c = {6{cpx_spc8_st_ack}} & cpx_spc8_st_ack_dc_inval_8c_tmp;

  wire [5:0] cpx_spc8_st_ack_ic_inval_8c_tmp = ~cpx_spc8_data_cx2[122] ? (
                                                                             cpx_spc8_data_cx2[1] + cpx_spc8_data_cx2[5]   +
                                                                             cpx_spc8_data_cx2[9] + cpx_spc8_data_cx2[13]  +
                                                                             cpx_spc8_data_cx2[17] + cpx_spc8_data_cx2[21] +
                                                                             cpx_spc8_data_cx2[25] + cpx_spc8_data_cx2[29]
                                                                           ) :
                                                                           ( cpx_spc8_data_cx2[57] + cpx_spc8_data_cx2[61] +
                                                                             cpx_spc8_data_cx2[65] + cpx_spc8_data_cx2[69] +
                                                                             cpx_spc8_data_cx2[73] + cpx_spc8_data_cx2[77] +
                                                                             cpx_spc8_data_cx2[81] + cpx_spc8_data_cx2[85]
                                                                           ) ;

  wire [5:0] cpx_spc8_st_ack_ic_inval_8c = {4{cpx_spc8_st_ack}} & cpx_spc8_st_ack_ic_inval_8c_tmp;

  wire [5:0] cpx_spc8_evict_dc_inval_8c_tmp =
									     cpx_spc8_data_cx2[0] + cpx_spc8_data_cx2[4] +
									     cpx_spc8_data_cx2[8] + cpx_spc8_data_cx2[12] +
									     cpx_spc8_data_cx2[16] + cpx_spc8_data_cx2[20] +
									     cpx_spc8_data_cx2[24] + cpx_spc8_data_cx2[28] +
  ...
  wire [5:0] cpx_spc8_evict_dc_inval_8c = {6{cpx_spc8_evict}} & cpx_spc8_evict_dc_inval_8c_tmp;

  wire [5:0] cpx_spc8_evict_ic_inval_8c_tmp =
                                                                             cpx_spc8_data_cx2[1] + cpx_spc8_data_cx2[5] +
                                                                             cpx_spc8_data_cx2[9] + cpx_spc8_data_cx2[13] +
                                                                             cpx_spc8_data_cx2[17] + cpx_spc8_data_cx2[21] +
                                                                             cpx_spc8_data_cx2[25] + cpx_spc8_data_cx2[29] +
  ...
  wire [5:0] cpx_spc8_evict_ic_inval_8c = {6{cpx_spc8_evict}} & cpx_spc8_evict_ic_inval_8c_tmp;

  reg [3:0] 	blk_st_cnt8;			// counts the number of block  stores without an acknowledge in between
  reg [3:0] 	ini_st_cnt8;			// counts the number of init   stores without an acknowledge in between
  reg  		st_blkst_mixture8;		// a flag set upon detection of block store and normal store mixture.
  reg  		st_inist_mixture8;		// a flag set upon detection of init  store and normal store mixture.
  reg 		atomic_ret8;			// atomic  cpx to spc package
  reg 		non_b2b_atomic_ret8;		// atomic  cpx to spc package did not return in back to back cycles
`endif
...
`ifdef RTL_SPARC8
  pcx8_vld_d1 	<= spc8_pcx_data_pa[123];
  pcx8_type_d1 	<= spc8_pcx_data_pa[122:118];
  pcx8_req_pq_d1 	<= |spc8_pcx_req_pq;
  pcx8_atom_pq_d1 	<= spc8_pcx_atom_pq;
  pcx8_atom_pq_d2 	<= pcx8_atom_pq_d1;


// Multiple block stores without an ACK in between
//---------------------------------------------------
  if((cpx_spc8_type == `ST_ACK) | ~rst_l)
    blk_st_cnt8 <=  4'h0;
  else if(pcx8_req_pq_d1 & (spc8_pcx_data_pa[122:118] == `STORE_RQ) & spc8_pcx_data_pa[109] & spc8_pcx_data_pa[110])
    blk_st_cnt8 <= blk_st_cnt8 + 1'b1;

// detect if a normal store came while this counter is not zero.
//--------------------------------------------------------------
  if(blk_st_cnt8 & (spc8_pcx_data_pa[122:118] == `STORE_RQ) & ~spc8_pcx_data_pa[109])
    st_blkst_mixture8 <= 1'b1;
  else if(blk_st_cnt8 == 4'h0)
    st_blkst_mixture8 <= 1'b0;
...
//---------------------------------------------------
  if((cpx_spc8_type == `ST_ACK) | ~rst_l)
    ...
    ini_st_cnt8 <= ini_st_cnt8 + 1'b1;

// detect if a normal store came while this counter is not zero.
//--------------------------------------------------------------
  if(ini_st_cnt8 && (spc8_pcx_data_pa[122:118] == `STORE_RQ) & ~spc8_pcx_data_pa[109])
    st_inist_mixture8 <= 1'b1;
  else if(ini_st_cnt8 == 4'h0)
    st_inist_mixture8 <= 1'b0;

  if(~rst_l)
    cpx_spc8_ifill_wyvld <= 1'b0;
  else
    cpx_spc8_ifill_wyvld <= ((cpx_spc8_type == `IFILL_RET) & cpx_spc8_wyvld);

  if(~rst_l)
    cpx_spc8_dfill_wyvld <= 1'b0;
  else
    cpx_spc8_dfill_wyvld <= ((cpx_spc8_type == `LOAD_RET) & cpx_spc8_wyvld);
`endif
...
`ifdef RTL_SPARC8
  if (rst_l & (^spc8_pcx_req_pq === 1'bx))
     finish_test("spc", "pcx_req_pq has X-s", 8);
  else if(rst_l & pcx8_req_pq_d1)
     get_pcx(	spc8_pcx_type_str, spc8_pcx_data_pa, pcx8_type_d1,
		pcx8_atom_pq_d1, pcx8_atom_pq_d2, 3'd0, pcx8_req_pq_d1);
`endif
...
`ifdef RTL_SPARC8
       if(cpx_spc8_data_vld & (cpx_spc8_type == `LOAD_RET) & cpx_spc8_data_cx2[129])
       begin
           atomic_ret8 <= 1'b1;
           if(tso_mon_msg) $display("tso_mon: atomic_ret8 = 1");
       end
       else if(cpx_spc8_data_vld & (cpx_spc8_type == `ST_ACK) & cpx_spc8_data_cx2[129])
       begin
           atomic_ret8 <= 1'b0;
           if(tso_mon_msg) $display("tso_mon: atomic_ret8 = 0");
       end

       if(atomic_ret8 & cpx_spc8_data_vld & ~(cpx_spc8_type == `ST_ACK))
       begin
           non_b2b_atomic_ret8 <= 1'b1;
           if(tso_mon_msg) $display("tso_mon: non_b2b_atomic_ret0");
       end
       else
          non_b2b_atomic_ret8 <= 1'b0;
`endif
...
`ifdef RTL_SPARC8
  if(cpx_spc8_data_vld)
    get_cpx_spc(cpx_spc8_type_str, cpx_spc8_type);
  if(tso_mon_msg)
    $display("%0d:Info cpx-to-spc%d packet TYPE= %s data= %x", $time, 8, cpx_spc8_type_str, cpx_spc8_data_cx2[127:0]);
`endif
...
`ifdef RTL_SPARC4
`ifndef RTL_SPU
wire   C4T0_stb_ne    = |`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C4T1_stb_ne    = |`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C4T2_stb_ne    = |`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C4T3_stb_ne    = |`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C4T0_stb_nced  = |(   `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0] &
                ~`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C4T1_stb_nced  = |(   `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0] &
                ~`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C4T2_stb_nced  = |(   `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0] &
                ~`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C4T3_stb_nced  = |(   `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0] &
                ~`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc4_lsu_ifill_pkt_vld   = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc4_dfq_rd_advance          = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_rd_advance;
wire   spc4_dfq_int_type        = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_int_type;

wire   spc4_ifu_lsu_inv_clear   = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.ifu_lsu_inv_clear;

wire        spc4_dva_svld_e         = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dva_svld_e;
wire        spc4_dva_rvld_e     = `SPARC_CORE4.sparc0.lsu.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc4_dva_rd_addr_e      = `SPARC_CORE4.sparc0.lsu.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [`L1D_ADDRESS_HI-6:0]  spc4_dva_snp_addr_e     = `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dva_snp_addr_e[`L1D_ADDRESS_HI-6:0];

wire [4:0]  spc4_stb_data_rd_ptr    = `SPARC_CORE4.sparc0.lsu.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc4_stb_data_wr_ptr    = `SPARC_CORE4.sparc0.lsu.lsu.stb_data_wr_ptr[4:0];
wire        spc4_stb_data_wptr_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_data_wptr_vld;
wire        spc4_stb_data_rptr_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_data_rptr_vld;
wire        spc4_stbrwctl_flush_pipe_w = `SPARC_CORE4.sparc0.lsu.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc4_lsu_st_pcx_rq_pick     = |`SPARC_CORE4.sparc0.lsu.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [`L1D_WAY_ARRAY_MASK]  spc4_lsu_rd_dtag_parity_g = `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_rd_dtag_parity_g[`L1D_WAY_ARRAY_MASK];
wire [`L1D_WAY_ARRAY_MASK]  spc4_dva_vld_g       = `SPARC_CORE4.sparc0.lsu.lsu.dctl.dva_vld_g[`L1D_WAY_ARRAY_MASK];
...
wire   C4T0_stb_full  = &`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C4T1_stb_full  = &`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C4T2_stb_full  = &`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C4T3_stb_full  = &`SPARC_CORE4.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C4T0_stb_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C4T1_stb_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C4T2_stb_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C4T3_stb_vld  = `SPARC_CORE4.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];
`else
...
wire [`L1D_ADDRESS_HI:4] spc4_dva_rd_addr_e  	= `SPARC_CORE4.sparc0.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
...
`ifndef RTL_SPU
wire   C4T0_st_ack  = &`SPARC_CORE4.sparc0.lsu.lsu.cpx_st_ack_tid0;
wire   C4T1_st_ack  = &`SPARC_CORE4.sparc0.lsu.lsu.cpx_st_ack_tid1;
wire   C4T2_st_ack  = &`SPARC_CORE4.sparc0.lsu.lsu.cpx_st_ack_tid2;
wire   C4T3_st_ack  = &`SPARC_CORE4.sparc0.lsu.lsu.cpx_st_ack_tid3;

wire   C4T0_defr_trp_en = &`SPARC_CORE4.sparc0.lsu.lsu.excpctl.st_defr_trp_en0;
wire   C4T1_defr_trp_en = &`SPARC_CORE4.sparc0.lsu.lsu.excpctl.st_defr_trp_en1;
wire   C4T2_defr_trp_en = &`SPARC_CORE4.sparc0.lsu.lsu.excpctl.st_defr_trp_en2;
wire   C4T3_defr_trp_en = &`SPARC_CORE4.sparc0.lsu.lsu.excpctl.st_defr_trp_en3;
`else
...
wire       spc4_stb_cam_hit     = `SPARC_CORE4.sparc0.lsu.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc4_lsu_way_hit     = `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc4_lsu_ifu_ldst_miss_w = `SPARC_CORE4.sparc0.lsu.lsu.lsu_ifu_ldst_miss_w;
wire       spc4_ld_inst_vld_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.ld_inst_vld_g;
wire       spc4_ldst_dbl_g      = `SPARC_CORE4.sparc0.lsu.lsu.dctl.ldst_dbl_g;
wire       spc4_quad_asi_g      = `SPARC_CORE4.sparc0.lsu.lsu.dctl.quad_asi_g;
wire [1:0] spc4_ldst_sz_g       = `SPARC_CORE4.sparc0.lsu.lsu.dctl.ldst_sz_g;
wire       spc4_lsu_alt_space_g = `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_alt_space_g;

wire       spc4_mbar_inst0_g        = `SPARC_CORE4.sparc0.lsu.lsu.dctl.mbar_inst0_g;
wire       spc4_mbar_inst1_g        = `SPARC_CORE4.sparc0.lsu.lsu.dctl.mbar_inst1_g;
wire       spc4_mbar_inst2_g        = `SPARC_CORE4.sparc0.lsu.lsu.dctl.mbar_inst2_g;
wire       spc4_mbar_inst3_g        = `SPARC_CORE4.sparc0.lsu.lsu.dctl.mbar_inst3_g;

wire       spc4_flush_inst0_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.flush_inst0_g;
wire       spc4_flush_inst1_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.flush_inst1_g;
wire       spc4_flush_inst2_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.flush_inst2_g;
wire       spc4_flush_inst3_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.flush_inst3_g;

wire       spc4_intrpt_disp_asi0_g  = `SPARC_CORE4.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc4_sas_thrid_w == 2'b00);
wire       spc4_intrpt_disp_asi1_g  = `SPARC_CORE4.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc4_sas_thrid_w == 2'b01);
wire       spc4_intrpt_disp_asi2_g  = `SPARC_CORE4.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc4_sas_thrid_w == 2'b10);
wire       spc4_intrpt_disp_asi3_g  = `SPARC_CORE4.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc4_sas_thrid_w == 2'b11);

wire       spc4_st_inst_vld_g   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.st_inst_vld_g;
wire       spc4_non_altspace_ldst_g = `SPARC_CORE4.sparc0.lsu.lsu.dctl.non_altspace_ldst_g;

wire       spc4_dctl_flush_pipe_w   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc4_no_spc_rmo_st   = `SPARC_CORE4.sparc0.lsu.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc4_ldst_fp_e       = `SPARC_CORE4.sparc0.lsu.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc4_stb_rdptr       = `SPARC_CORE4.sparc0.lsu.lsu.stb_rwctl.stb_rdptr_l;

wire       spc4_ld_l2cache_req  = `SPARC_CORE4.sparc0.lsu.lsu.qctl1.ld3_l2cache_rq |
                      `SPARC_CORE4.sparc0.lsu.lsu.qctl1.ld2_l2cache_rq |
                              `SPARC_CORE4.sparc0.lsu.lsu.qctl1.ld1_l2cache_rq |
                      `SPARC_CORE4.sparc0.lsu.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc4_dcache_enable   = {`SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_ctl_reg0[1],
                                           `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_ctl_reg1[1],
                       `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_ctl_reg2[1],
                       `SPARC_CORE4.sparc0.lsu.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc4_icache_enable   = `SPARC_CORE4.sparc0.lsu.lsu.lsu_ifu_icache_en[3:0];

wire spc4_dc_direct_map         = `SPARC_CORE4.sparc0.lsu.lsu.dc_direct_map;
wire spc4_lsu_ifu_direct_map_l1 = `SPARC_CORE4.sparc0.lsu.lsu.lsu_ifu_direct_map_l1;
`else
...
wire [`L1D_WAY_ARRAY_MASK] spc4_lsu_way_hit		= `SPARC_CORE4.sparc0.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
...
reg [`L1D_ADDRESS_HI:4] 	spc4_dva_rd_addr_e_d1;
...
// I provided a command line argument to disable this check.
  ...
  if(spc4_dva_svld_e_d1 & spc4_dva_rvld_e & (spc4_dva_rd_addr_e_d1[`L1D_ADDRESS_HI:6] == spc4_dva_snp_addr_e[4:0]))
    spc4_lsu_rd_after_snp <= 1'b1;
  else
    spc4_lsu_rd_after_snp <= 1'b0;

  if(spc4_dva_svld_e & spc4_dva_rvld_e_d1 & (spc4_dva_rd_addr_e[`L1D_ADDRESS_HI:6] == spc4_dva_snp_addr_e_d1[4:0]))
...
`ifdef RTL_SPARC5
`ifndef RTL_SPU
wire   C5T0_stb_ne    = |`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C5T1_stb_ne    = |`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C5T2_stb_ne    = |`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C5T3_stb_ne    = |`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C5T0_stb_nced  = |(   `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0] &
                ~`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C5T1_stb_nced  = |(   `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0] &
                ~`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C5T2_stb_nced  = |(   `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0] &
                ~`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C5T3_stb_nced  = |(   `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0] &
                ~`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc5_lsu_ifill_pkt_vld   = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc5_dfq_rd_advance          = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_rd_advance;
wire   spc5_dfq_int_type        = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_int_type;

wire   spc5_ifu_lsu_inv_clear   = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.ifu_lsu_inv_clear;

wire        spc5_dva_svld_e         = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dva_svld_e;
wire        spc5_dva_rvld_e     = `SPARC_CORE5.sparc0.lsu.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc5_dva_rd_addr_e      = `SPARC_CORE5.sparc0.lsu.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [`L1D_ADDRESS_HI-6:0]  spc5_dva_snp_addr_e     = `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dva_snp_addr_e[`L1D_ADDRESS_HI-6:0];

wire [4:0]  spc5_stb_data_rd_ptr    = `SPARC_CORE5.sparc0.lsu.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc5_stb_data_wr_ptr    = `SPARC_CORE5.sparc0.lsu.lsu.stb_data_wr_ptr[4:0];
wire        spc5_stb_data_wptr_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_data_wptr_vld;
wire        spc5_stb_data_rptr_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_data_rptr_vld;
wire        spc5_stbrwctl_flush_pipe_w = `SPARC_CORE5.sparc0.lsu.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc5_lsu_st_pcx_rq_pick     = |`SPARC_CORE5.sparc0.lsu.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [`L1D_WAY_ARRAY_MASK]  spc5_lsu_rd_dtag_parity_g = `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_rd_dtag_parity_g[`L1D_WAY_ARRAY_MASK];
wire [`L1D_WAY_ARRAY_MASK]  spc5_dva_vld_g       = `SPARC_CORE5.sparc0.lsu.lsu.dctl.dva_vld_g[`L1D_WAY_ARRAY_MASK];
...
wire   C5T0_stb_full  = &`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C5T1_stb_full  = &`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C5T2_stb_full  = &`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C5T3_stb_full  = &`SPARC_CORE5.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C5T0_stb_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C5T1_stb_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C5T2_stb_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C5T3_stb_vld  = `SPARC_CORE5.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];
`else
...
wire [`L1D_ADDRESS_HI:4] spc5_dva_rd_addr_e  	= `SPARC_CORE5.sparc0.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
...
`ifndef RTL_SPU
wire   C5T0_st_ack  = &`SPARC_CORE5.sparc0.lsu.lsu.cpx_st_ack_tid0;
wire   C5T1_st_ack  = &`SPARC_CORE5.sparc0.lsu.lsu.cpx_st_ack_tid1;
wire   C5T2_st_ack  = &`SPARC_CORE5.sparc0.lsu.lsu.cpx_st_ack_tid2;
wire   C5T3_st_ack  = &`SPARC_CORE5.sparc0.lsu.lsu.cpx_st_ack_tid3;

wire   C5T0_defr_trp_en = &`SPARC_CORE5.sparc0.lsu.lsu.excpctl.st_defr_trp_en0;
wire   C5T1_defr_trp_en = &`SPARC_CORE5.sparc0.lsu.lsu.excpctl.st_defr_trp_en1;
wire   C5T2_defr_trp_en = &`SPARC_CORE5.sparc0.lsu.lsu.excpctl.st_defr_trp_en2;
wire   C5T3_defr_trp_en = &`SPARC_CORE5.sparc0.lsu.lsu.excpctl.st_defr_trp_en3;
`else
...
wire       spc5_stb_cam_hit     = `SPARC_CORE5.sparc0.lsu.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc5_lsu_way_hit     = `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc5_lsu_ifu_ldst_miss_w = `SPARC_CORE5.sparc0.lsu.lsu.lsu_ifu_ldst_miss_w;
wire       spc5_ld_inst_vld_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.ld_inst_vld_g;
wire       spc5_ldst_dbl_g      = `SPARC_CORE5.sparc0.lsu.lsu.dctl.ldst_dbl_g;
wire       spc5_quad_asi_g      = `SPARC_CORE5.sparc0.lsu.lsu.dctl.quad_asi_g;
wire [1:0] spc5_ldst_sz_g       = `SPARC_CORE5.sparc0.lsu.lsu.dctl.ldst_sz_g;
wire       spc5_lsu_alt_space_g = `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_alt_space_g;

wire       spc5_mbar_inst0_g        = `SPARC_CORE5.sparc0.lsu.lsu.dctl.mbar_inst0_g;
wire       spc5_mbar_inst1_g        = `SPARC_CORE5.sparc0.lsu.lsu.dctl.mbar_inst1_g;
wire       spc5_mbar_inst2_g        = `SPARC_CORE5.sparc0.lsu.lsu.dctl.mbar_inst2_g;
wire       spc5_mbar_inst3_g        = `SPARC_CORE5.sparc0.lsu.lsu.dctl.mbar_inst3_g;

wire       spc5_flush_inst0_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.flush_inst0_g;
wire       spc5_flush_inst1_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.flush_inst1_g;
wire       spc5_flush_inst2_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.flush_inst2_g;
wire       spc5_flush_inst3_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.flush_inst3_g;

wire       spc5_intrpt_disp_asi0_g  = `SPARC_CORE5.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc5_sas_thrid_w == 2'b00);
wire       spc5_intrpt_disp_asi1_g  = `SPARC_CORE5.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc5_sas_thrid_w == 2'b01);
wire       spc5_intrpt_disp_asi2_g  = `SPARC_CORE5.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc5_sas_thrid_w == 2'b10);
wire       spc5_intrpt_disp_asi3_g  = `SPARC_CORE5.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc5_sas_thrid_w == 2'b11);

wire       spc5_st_inst_vld_g   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.st_inst_vld_g;
wire       spc5_non_altspace_ldst_g = `SPARC_CORE5.sparc0.lsu.lsu.dctl.non_altspace_ldst_g;

wire       spc5_dctl_flush_pipe_w   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc5_no_spc_rmo_st   = `SPARC_CORE5.sparc0.lsu.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc5_ldst_fp_e       = `SPARC_CORE5.sparc0.lsu.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc5_stb_rdptr       = `SPARC_CORE5.sparc0.lsu.lsu.stb_rwctl.stb_rdptr_l;

wire       spc5_ld_l2cache_req  = `SPARC_CORE5.sparc0.lsu.lsu.qctl1.ld3_l2cache_rq |
                      `SPARC_CORE5.sparc0.lsu.lsu.qctl1.ld2_l2cache_rq |
                              `SPARC_CORE5.sparc0.lsu.lsu.qctl1.ld1_l2cache_rq |
                      `SPARC_CORE5.sparc0.lsu.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc5_dcache_enable   = {`SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_ctl_reg0[1],
                                           `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_ctl_reg1[1],
                       `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_ctl_reg2[1],
                       `SPARC_CORE5.sparc0.lsu.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc5_icache_enable   = `SPARC_CORE5.sparc0.lsu.lsu.lsu_ifu_icache_en[3:0];

wire spc5_dc_direct_map         = `SPARC_CORE5.sparc0.lsu.lsu.dc_direct_map;
wire spc5_lsu_ifu_direct_map_l1 = `SPARC_CORE5.sparc0.lsu.lsu.lsu_ifu_direct_map_l1;
`else
...
wire [`L1D_WAY_ARRAY_MASK] spc5_lsu_way_hit		= `SPARC_CORE5.sparc0.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
...
reg [`L1D_ADDRESS_HI:4] 	spc5_dva_rd_addr_e_d1;
...
// I provided a command line argument to disable this check.
  ...
  if(spc5_dva_svld_e_d1 & spc5_dva_rvld_e & (spc5_dva_rd_addr_e_d1[`L1D_ADDRESS_HI:6] == spc5_dva_snp_addr_e[4:0]))
    spc5_lsu_rd_after_snp <= 1'b1;
  else
    spc5_lsu_rd_after_snp <= 1'b0;

  if(spc5_dva_svld_e & spc5_dva_rvld_e_d1 & (spc5_dva_rd_addr_e[`L1D_ADDRESS_HI:6] == spc5_dva_snp_addr_e_d1[4:0]))
...
`ifdef RTL_SPARC6
`ifndef RTL_SPU
wire   C6T0_stb_ne    = |`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C6T1_stb_ne    = |`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C6T2_stb_ne    = |`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C6T3_stb_ne    = |`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C6T0_stb_nced  = |(   `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0] &
                ~`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C6T1_stb_nced  = |(   `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0] &
                ~`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C6T2_stb_nced  = |(   `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0] &
                ~`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C6T3_stb_nced  = |(   `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0] &
                ~`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc6_lsu_ifill_pkt_vld   = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc6_dfq_rd_advance          = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_rd_advance;
wire   spc6_dfq_int_type        = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_int_type;

wire   spc6_ifu_lsu_inv_clear   = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.ifu_lsu_inv_clear;

wire        spc6_dva_svld_e         = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dva_svld_e;
wire        spc6_dva_rvld_e     = `SPARC_CORE6.sparc0.lsu.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc6_dva_rd_addr_e      = `SPARC_CORE6.sparc0.lsu.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [`L1D_ADDRESS_HI-6:0]  spc6_dva_snp_addr_e     = `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dva_snp_addr_e[`L1D_ADDRESS_HI-6:0];

wire [4:0]  spc6_stb_data_rd_ptr    = `SPARC_CORE6.sparc0.lsu.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc6_stb_data_wr_ptr    = `SPARC_CORE6.sparc0.lsu.lsu.stb_data_wr_ptr[4:0];
wire        spc6_stb_data_wptr_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_data_wptr_vld;
wire        spc6_stb_data_rptr_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_data_rptr_vld;
wire        spc6_stbrwctl_flush_pipe_w = `SPARC_CORE6.sparc0.lsu.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc6_lsu_st_pcx_rq_pick     = |`SPARC_CORE6.sparc0.lsu.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [`L1D_WAY_ARRAY_MASK]  spc6_lsu_rd_dtag_parity_g = `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_rd_dtag_parity_g[`L1D_WAY_ARRAY_MASK];
wire [`L1D_WAY_ARRAY_MASK]  spc6_dva_vld_g       = `SPARC_CORE6.sparc0.lsu.lsu.dctl.dva_vld_g[`L1D_WAY_ARRAY_MASK];
...
wire   C6T0_stb_full  = &`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C6T1_stb_full  = &`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C6T2_stb_full  = &`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C6T3_stb_full  = &`SPARC_CORE6.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C6T0_stb_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C6T1_stb_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C6T2_stb_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C6T3_stb_vld  = `SPARC_CORE6.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];
`else
...
wire [`L1D_ADDRESS_HI:4] spc6_dva_rd_addr_e  	= `SPARC_CORE6.sparc0.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
...
`ifndef RTL_SPU
wire   C6T0_st_ack  = &`SPARC_CORE6.sparc0.lsu.lsu.cpx_st_ack_tid0;
wire   C6T1_st_ack  = &`SPARC_CORE6.sparc0.lsu.lsu.cpx_st_ack_tid1;
wire   C6T2_st_ack  = &`SPARC_CORE6.sparc0.lsu.lsu.cpx_st_ack_tid2;
wire   C6T3_st_ack  = &`SPARC_CORE6.sparc0.lsu.lsu.cpx_st_ack_tid3;

wire   C6T0_defr_trp_en = &`SPARC_CORE6.sparc0.lsu.lsu.excpctl.st_defr_trp_en0;
wire   C6T1_defr_trp_en = &`SPARC_CORE6.sparc0.lsu.lsu.excpctl.st_defr_trp_en1;
wire   C6T2_defr_trp_en = &`SPARC_CORE6.sparc0.lsu.lsu.excpctl.st_defr_trp_en2;
wire   C6T3_defr_trp_en = &`SPARC_CORE6.sparc0.lsu.lsu.excpctl.st_defr_trp_en3;
`else
...
wire       spc6_stb_cam_hit     = `SPARC_CORE6.sparc0.lsu.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc6_lsu_way_hit     = `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc6_lsu_ifu_ldst_miss_w = `SPARC_CORE6.sparc0.lsu.lsu.lsu_ifu_ldst_miss_w;
wire       spc6_ld_inst_vld_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.ld_inst_vld_g;
wire       spc6_ldst_dbl_g      = `SPARC_CORE6.sparc0.lsu.lsu.dctl.ldst_dbl_g;
wire       spc6_quad_asi_g      = `SPARC_CORE6.sparc0.lsu.lsu.dctl.quad_asi_g;
wire [1:0] spc6_ldst_sz_g       = `SPARC_CORE6.sparc0.lsu.lsu.dctl.ldst_sz_g;
wire       spc6_lsu_alt_space_g = `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_alt_space_g;

wire       spc6_mbar_inst0_g        = `SPARC_CORE6.sparc0.lsu.lsu.dctl.mbar_inst0_g;
wire       spc6_mbar_inst1_g        = `SPARC_CORE6.sparc0.lsu.lsu.dctl.mbar_inst1_g;
wire       spc6_mbar_inst2_g        = `SPARC_CORE6.sparc0.lsu.lsu.dctl.mbar_inst2_g;
wire       spc6_mbar_inst3_g        = `SPARC_CORE6.sparc0.lsu.lsu.dctl.mbar_inst3_g;

wire       spc6_flush_inst0_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.flush_inst0_g;
wire       spc6_flush_inst1_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.flush_inst1_g;
wire       spc6_flush_inst2_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.flush_inst2_g;
wire       spc6_flush_inst3_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.flush_inst3_g;

wire       spc6_intrpt_disp_asi0_g  = `SPARC_CORE6.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc6_sas_thrid_w == 2'b00);
wire       spc6_intrpt_disp_asi1_g  = `SPARC_CORE6.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc6_sas_thrid_w == 2'b01);
wire       spc6_intrpt_disp_asi2_g  = `SPARC_CORE6.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc6_sas_thrid_w == 2'b10);
wire       spc6_intrpt_disp_asi3_g  = `SPARC_CORE6.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc6_sas_thrid_w == 2'b11);

wire       spc6_st_inst_vld_g   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.st_inst_vld_g;
wire       spc6_non_altspace_ldst_g = `SPARC_CORE6.sparc0.lsu.lsu.dctl.non_altspace_ldst_g;

wire       spc6_dctl_flush_pipe_w   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc6_no_spc_rmo_st   = `SPARC_CORE6.sparc0.lsu.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc6_ldst_fp_e       = `SPARC_CORE6.sparc0.lsu.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc6_stb_rdptr       = `SPARC_CORE6.sparc0.lsu.lsu.stb_rwctl.stb_rdptr_l;

wire       spc6_ld_l2cache_req  = `SPARC_CORE6.sparc0.lsu.lsu.qctl1.ld3_l2cache_rq |
                      `SPARC_CORE6.sparc0.lsu.lsu.qctl1.ld2_l2cache_rq |
                              `SPARC_CORE6.sparc0.lsu.lsu.qctl1.ld1_l2cache_rq |
                      `SPARC_CORE6.sparc0.lsu.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc6_dcache_enable   = {`SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_ctl_reg0[1],
                                           `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_ctl_reg1[1],
                       `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_ctl_reg2[1],
                       `SPARC_CORE6.sparc0.lsu.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc6_icache_enable   = `SPARC_CORE6.sparc0.lsu.lsu.lsu_ifu_icache_en[3:0];

wire spc6_dc_direct_map         = `SPARC_CORE6.sparc0.lsu.lsu.dc_direct_map;
wire spc6_lsu_ifu_direct_map_l1 = `SPARC_CORE6.sparc0.lsu.lsu.lsu_ifu_direct_map_l1;
`else
...
wire [`L1D_WAY_ARRAY_MASK] spc6_lsu_way_hit		= `SPARC_CORE6.sparc0.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
...
reg [`L1D_ADDRESS_HI:4] 	spc6_dva_rd_addr_e_d1;
...
// I provided a command line argument to disable this check.
  ...
  if(spc6_dva_svld_e_d1 & spc6_dva_rvld_e & (spc6_dva_rd_addr_e_d1[`L1D_ADDRESS_HI:6] == spc6_dva_snp_addr_e[4:0]))
    spc6_lsu_rd_after_snp <= 1'b1;
  else
    spc6_lsu_rd_after_snp <= 1'b0;

  if(spc6_dva_svld_e & spc6_dva_rvld_e_d1 & (spc6_dva_rd_addr_e[`L1D_ADDRESS_HI:6] == spc6_dva_snp_addr_e_d1[4:0]))
...
`ifdef RTL_SPARC7
`ifndef RTL_SPU
wire   C7T0_stb_ne    = |`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C7T1_stb_ne    = |`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C7T2_stb_ne    = |`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C7T3_stb_ne    = |`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C7T0_stb_nced  = |(   `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0] &
                ~`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C7T1_stb_nced  = |(   `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0] &
                ~`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C7T2_stb_nced  = |(   `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0] &
                ~`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C7T3_stb_nced  = |(   `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0] &
                ~`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc7_lsu_ifill_pkt_vld   = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc7_dfq_rd_advance          = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_rd_advance;
wire   spc7_dfq_int_type        = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_int_type;

wire   spc7_ifu_lsu_inv_clear   = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.ifu_lsu_inv_clear;

wire        spc7_dva_svld_e         = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dva_svld_e;
wire        spc7_dva_rvld_e     = `SPARC_CORE7.sparc0.lsu.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc7_dva_rd_addr_e      = `SPARC_CORE7.sparc0.lsu.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [`L1D_ADDRESS_HI-6:0]  spc7_dva_snp_addr_e     = `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dva_snp_addr_e[`L1D_ADDRESS_HI-6:0];

wire [4:0]  spc7_stb_data_rd_ptr    = `SPARC_CORE7.sparc0.lsu.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc7_stb_data_wr_ptr    = `SPARC_CORE7.sparc0.lsu.lsu.stb_data_wr_ptr[4:0];
wire        spc7_stb_data_wptr_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_data_wptr_vld;
wire        spc7_stb_data_rptr_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_data_rptr_vld;
wire        spc7_stbrwctl_flush_pipe_w = `SPARC_CORE7.sparc0.lsu.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc7_lsu_st_pcx_rq_pick     = |`SPARC_CORE7.sparc0.lsu.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [`L1D_WAY_ARRAY_MASK]  spc7_lsu_rd_dtag_parity_g = `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_rd_dtag_parity_g[`L1D_WAY_ARRAY_MASK];
wire [`L1D_WAY_ARRAY_MASK]  spc7_dva_vld_g       = `SPARC_CORE7.sparc0.lsu.lsu.dctl.dva_vld_g[`L1D_WAY_ARRAY_MASK];
...
wire   C7T0_stb_full  = &`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C7T1_stb_full  = &`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C7T2_stb_full  = &`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C7T3_stb_full  = &`SPARC_CORE7.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C7T0_stb_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C7T1_stb_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C7T2_stb_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C7T3_stb_vld  = `SPARC_CORE7.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];
`else
...
wire [`L1D_ADDRESS_HI:4] spc7_dva_rd_addr_e  	= `SPARC_CORE7.sparc0.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
...
`ifndef RTL_SPU
wire   C7T0_st_ack  = &`SPARC_CORE7.sparc0.lsu.lsu.cpx_st_ack_tid0;
wire   C7T1_st_ack  = &`SPARC_CORE7.sparc0.lsu.lsu.cpx_st_ack_tid1;
wire   C7T2_st_ack  = &`SPARC_CORE7.sparc0.lsu.lsu.cpx_st_ack_tid2;
wire   C7T3_st_ack  = &`SPARC_CORE7.sparc0.lsu.lsu.cpx_st_ack_tid3;

wire   C7T0_defr_trp_en = &`SPARC_CORE7.sparc0.lsu.lsu.excpctl.st_defr_trp_en0;
wire   C7T1_defr_trp_en = &`SPARC_CORE7.sparc0.lsu.lsu.excpctl.st_defr_trp_en1;
wire   C7T2_defr_trp_en = &`SPARC_CORE7.sparc0.lsu.lsu.excpctl.st_defr_trp_en2;
wire   C7T3_defr_trp_en = &`SPARC_CORE7.sparc0.lsu.lsu.excpctl.st_defr_trp_en3;
`else
...
wire       spc7_stb_cam_hit     = `SPARC_CORE7.sparc0.lsu.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc7_lsu_way_hit     = `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc7_lsu_ifu_ldst_miss_w = `SPARC_CORE7.sparc0.lsu.lsu.lsu_ifu_ldst_miss_w;
wire       spc7_ld_inst_vld_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.ld_inst_vld_g;
wire       spc7_ldst_dbl_g      = `SPARC_CORE7.sparc0.lsu.lsu.dctl.ldst_dbl_g;
wire       spc7_quad_asi_g      = `SPARC_CORE7.sparc0.lsu.lsu.dctl.quad_asi_g;
wire [1:0] spc7_ldst_sz_g       = `SPARC_CORE7.sparc0.lsu.lsu.dctl.ldst_sz_g;
wire       spc7_lsu_alt_space_g = `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_alt_space_g;

wire       spc7_mbar_inst0_g        = `SPARC_CORE7.sparc0.lsu.lsu.dctl.mbar_inst0_g;
wire       spc7_mbar_inst1_g        = `SPARC_CORE7.sparc0.lsu.lsu.dctl.mbar_inst1_g;
wire       spc7_mbar_inst2_g        = `SPARC_CORE7.sparc0.lsu.lsu.dctl.mbar_inst2_g;
wire       spc7_mbar_inst3_g        = `SPARC_CORE7.sparc0.lsu.lsu.dctl.mbar_inst3_g;

wire       spc7_flush_inst0_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.flush_inst0_g;
wire       spc7_flush_inst1_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.flush_inst1_g;
wire       spc7_flush_inst2_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.flush_inst2_g;
wire       spc7_flush_inst3_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.flush_inst3_g;

wire       spc7_intrpt_disp_asi0_g  = `SPARC_CORE7.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc7_sas_thrid_w == 2'b00);
wire       spc7_intrpt_disp_asi1_g  = `SPARC_CORE7.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc7_sas_thrid_w == 2'b01);
wire       spc7_intrpt_disp_asi2_g  = `SPARC_CORE7.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc7_sas_thrid_w == 2'b10);
wire       spc7_intrpt_disp_asi3_g  = `SPARC_CORE7.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc7_sas_thrid_w == 2'b11);

wire       spc7_st_inst_vld_g   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.st_inst_vld_g;
wire       spc7_non_altspace_ldst_g = `SPARC_CORE7.sparc0.lsu.lsu.dctl.non_altspace_ldst_g;

wire       spc7_dctl_flush_pipe_w   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc7_no_spc_rmo_st   = `SPARC_CORE7.sparc0.lsu.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc7_ldst_fp_e       = `SPARC_CORE7.sparc0.lsu.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc7_stb_rdptr       = `SPARC_CORE7.sparc0.lsu.lsu.stb_rwctl.stb_rdptr_l;

wire       spc7_ld_l2cache_req  = `SPARC_CORE7.sparc0.lsu.lsu.qctl1.ld3_l2cache_rq |
                      `SPARC_CORE7.sparc0.lsu.lsu.qctl1.ld2_l2cache_rq |
                              `SPARC_CORE7.sparc0.lsu.lsu.qctl1.ld1_l2cache_rq |
                      `SPARC_CORE7.sparc0.lsu.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc7_dcache_enable   = {`SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_ctl_reg0[1],
                                           `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_ctl_reg1[1],
                       `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_ctl_reg2[1],
                       `SPARC_CORE7.sparc0.lsu.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc7_icache_enable   = `SPARC_CORE7.sparc0.lsu.lsu.lsu_ifu_icache_en[3:0];

wire spc7_dc_direct_map         = `SPARC_CORE7.sparc0.lsu.lsu.dc_direct_map;
wire spc7_lsu_ifu_direct_map_l1 = `SPARC_CORE7.sparc0.lsu.lsu.lsu_ifu_direct_map_l1;
`else
...
wire [`L1D_WAY_ARRAY_MASK] spc7_lsu_way_hit		= `SPARC_CORE7.sparc0.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
...
reg [`L1D_ADDRESS_HI:4] 	spc7_dva_rd_addr_e_d1;
...
// I provided a command line argument to disable this check.
  ...
  if(spc7_dva_svld_e_d1 & spc7_dva_rvld_e & (spc7_dva_rd_addr_e_d1[`L1D_ADDRESS_HI:6] == spc7_dva_snp_addr_e[4:0]))
    spc7_lsu_rd_after_snp <= 1'b1;
  else
    spc7_lsu_rd_after_snp <= 1'b0;

  if(spc7_dva_svld_e & spc7_dva_rvld_e_d1 & (spc7_dva_rd_addr_e[`L1D_ADDRESS_HI:6] == spc7_dva_snp_addr_e_d1[4:0]))
...
`ifdef RTL_SPARC8
`ifndef RTL_SPU
wire   C8T0_stb_ne    = |`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C8T1_stb_ne    = |`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C8T2_stb_ne    = |`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C8T3_stb_ne    = |`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C8T0_stb_nced  = |(   `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0] &
                ~`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C8T1_stb_nced  = |(   `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0] &
                ~`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C8T2_stb_nced  = |(   `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0] &
                ~`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C8T3_stb_nced  = |(   `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0] &
                ~`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc8_lsu_ifill_pkt_vld   = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc8_dfq_rd_advance          = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_rd_advance;
wire   spc8_dfq_int_type        = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_int_type;

wire   spc8_ifu_lsu_inv_clear   = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.ifu_lsu_inv_clear;

wire        spc8_dva_svld_e         = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dva_svld_e;
wire        spc8_dva_rvld_e     = `SPARC_CORE8.sparc0.lsu.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc8_dva_rd_addr_e      = `SPARC_CORE8.sparc0.lsu.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [`L1D_ADDRESS_HI-6:0]  spc8_dva_snp_addr_e     = `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dva_snp_addr_e[`L1D_ADDRESS_HI-6:0];

wire [4:0]  spc8_stb_data_rd_ptr    = `SPARC_CORE8.sparc0.lsu.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc8_stb_data_wr_ptr    = `SPARC_CORE8.sparc0.lsu.lsu.stb_data_wr_ptr[4:0];
wire        spc8_stb_data_wptr_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_data_wptr_vld;
wire        spc8_stb_data_rptr_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_data_rptr_vld;
wire        spc8_stbrwctl_flush_pipe_w = `SPARC_CORE8.sparc0.lsu.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc8_lsu_st_pcx_rq_pick     = |`SPARC_CORE8.sparc0.lsu.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [`L1D_WAY_ARRAY_MASK]  spc8_lsu_rd_dtag_parity_g = `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_rd_dtag_parity_g[`L1D_WAY_ARRAY_MASK];
wire [`L1D_WAY_ARRAY_MASK]  spc8_dva_vld_g       = `SPARC_CORE8.sparc0.lsu.lsu.dctl.dva_vld_g[`L1D_WAY_ARRAY_MASK];

wire [3:0]  spc8_lsu_dc_tag_pe_g_unmasked    = spc8_lsu_rd_dtag_parity_g[3:0] & spc8_dva_vld_g[3:0];
wire        spc8_lsu_dc_tag_pe_g_unmasked_or = |spc8_lsu_dc_tag_pe_g_unmasked[3:0];

wire   C8T0_stb_full  = &`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C8T1_stb_full  = &`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C8T2_stb_full  = &`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C8T3_stb_full  = &`SPARC_CORE8.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C8T0_stb_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C8T1_stb_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C8T2_stb_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C8T3_stb_vld  = `SPARC_CORE8.sparc0.lsu.lsu.stb_ctl3.stb_state_vld[7:0];
`else
wire   C8T0_stb_ne    = |`SPARC_CORE8.sparc0.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C8T1_stb_ne    = |`SPARC_CORE8.sparc0.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C8T2_stb_ne    = |`SPARC_CORE8.sparc0.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C8T3_stb_ne    = |`SPARC_CORE8.sparc0.lsu.stb_ctl3.stb_state_vld[7:0];

wire   C8T0_stb_nced  = |(	 `SPARC_CORE8.sparc0.lsu.stb_ctl0.stb_state_vld[7:0] &
				~`SPARC_CORE8.sparc0.lsu.stb_ctl0.stb_state_ced[7:0]);
wire   C8T1_stb_nced  = |(	 `SPARC_CORE8.sparc0.lsu.stb_ctl1.stb_state_vld[7:0] &
				~`SPARC_CORE8.sparc0.lsu.stb_ctl1.stb_state_ced[7:0]);
wire   C8T2_stb_nced  = |(	 `SPARC_CORE8.sparc0.lsu.stb_ctl2.stb_state_vld[7:0] &
				~`SPARC_CORE8.sparc0.lsu.stb_ctl2.stb_state_ced[7:0]);
wire   C8T3_stb_nced  = |(	 `SPARC_CORE8.sparc0.lsu.stb_ctl3.stb_state_vld[7:0] &
				~`SPARC_CORE8.sparc0.lsu.stb_ctl3.stb_state_ced[7:0]);

wire   spc8_lsu_ifill_pkt_vld	= `SPARC_CORE8.sparc0.lsu.qctl2.lsu_ifill_pkt_vld;
wire   spc8_dfq_rd_advance  		= `SPARC_CORE8.sparc0.lsu.qctl2.dfq_rd_advance;
wire   spc8_dfq_int_type  		= `SPARC_CORE8.sparc0.lsu.qctl2.dfq_int_type;

wire   spc8_ifu_lsu_inv_clear	= `SPARC_CORE8.sparc0.lsu.qctl2.ifu_lsu_inv_clear;

wire 	    spc8_dva_svld_e 	 	= `SPARC_CORE8.sparc0.lsu.qctl2.dva_svld_e;
wire 	    spc8_dva_rvld_e	 	= `SPARC_CORE8.sparc0.lsu.dva.rd_en;
wire [`L1D_ADDRESS_HI:4] spc8_dva_rd_addr_e  	= `SPARC_CORE8.sparc0.lsu.dva.rd_adr1[`L1D_ADDRESS_HI-4:0];
wire [4:0]  spc8_dva_snp_addr_e 	= `SPARC_CORE8.sparc0.lsu.qctl2.dva_snp_addr_e[4:0];

wire [4:0]  spc8_stb_data_rd_ptr   	= `SPARC_CORE8.sparc0.lsu.stb_data_rd_ptr[4:0];
wire [4:0]  spc8_stb_data_wr_ptr   	= `SPARC_CORE8.sparc0.lsu.stb_data_wr_ptr[4:0];
wire        spc8_stb_data_wptr_vld 	= `SPARC_CORE8.sparc0.lsu.stb_data_wptr_vld;
wire        spc8_stb_data_rptr_vld 	= `SPARC_CORE8.sparc0.lsu.stb_data_rptr_vld;
wire        spc8_stbrwctl_flush_pipe_w = `SPARC_CORE8.sparc0.lsu.stb_rwctl.lsu_stbrwctl_flush_pipe_w;
wire        spc8_lsu_st_pcx_rq_pick 	= |`SPARC_CORE8.sparc0.lsu.stb_rwctl.lsu_st_pcx_rq_pick[3:0];

wire [3:0]  spc8_lsu_rd_dtag_parity_g = `SPARC_CORE8.sparc0.lsu.dctl.lsu_rd_dtag_parity_g[3:0];
wire [3:0]  spc8_dva_vld_g		 = `SPARC_CORE8.sparc0.lsu.dctl.dva_vld_g[3:0];

wire [3:0]  spc8_lsu_dc_tag_pe_g_unmasked    = spc8_lsu_rd_dtag_parity_g[3:0] & spc8_dva_vld_g[3:0];
wire        spc8_lsu_dc_tag_pe_g_unmasked_or = |spc8_lsu_dc_tag_pe_g_unmasked[3:0];

wire   C8T0_stb_full  = &`SPARC_CORE8.sparc0.lsu.stb_ctl0.stb_state_vld[7:0];
wire   C8T1_stb_full  = &`SPARC_CORE8.sparc0.lsu.stb_ctl1.stb_state_vld[7:0];
wire   C8T2_stb_full  = &`SPARC_CORE8.sparc0.lsu.stb_ctl2.stb_state_vld[7:0];
wire   C8T3_stb_full  = &`SPARC_CORE8.sparc0.lsu.stb_ctl3.stb_state_vld[7:0];

wire   [7:0] C8T0_stb_vld  = `SPARC_CORE8.sparc0.lsu.stb_ctl0.stb_state_vld[7:0];
wire   [7:0] C8T1_stb_vld  = `SPARC_CORE8.sparc0.lsu.stb_ctl1.stb_state_vld[7:0];
wire   [7:0] C8T2_stb_vld  = `SPARC_CORE8.sparc0.lsu.stb_ctl2.stb_state_vld[7:0];
wire   [7:0] C8T3_stb_vld  = `SPARC_CORE8.sparc0.lsu.stb_ctl3.stb_state_vld[7:0];
`endif

wire   [4:0] C8T0_stb_vld_sum  =  C8T0_stb_vld[0] +  C8T0_stb_vld[1] +  C8T0_stb_vld[2] +  C8T0_stb_vld[3] +
                                     C8T0_stb_vld[4] +  C8T0_stb_vld[5] +  C8T0_stb_vld[6] +  C8T0_stb_vld[7] ;
wire   [4:0] C8T1_stb_vld_sum  =  C8T1_stb_vld[0] +  C8T1_stb_vld[1] +  C8T1_stb_vld[2] +  C8T1_stb_vld[3] +
                                     C8T1_stb_vld[4] +  C8T1_stb_vld[5] +  C8T1_stb_vld[6] +  C8T1_stb_vld[7] ;
wire   [4:0] C8T2_stb_vld_sum  =  C8T2_stb_vld[0] +  C8T2_stb_vld[1] +  C8T2_stb_vld[2] +  C8T2_stb_vld[3] +
                                     C8T2_stb_vld[4] +  C8T2_stb_vld[5] +  C8T2_stb_vld[6] +  C8T2_stb_vld[7] ;
wire   [4:0] C8T3_stb_vld_sum  =  C8T3_stb_vld[0] +  C8T3_stb_vld[1] +  C8T3_stb_vld[2] +  C8T3_stb_vld[3] +
                                     C8T3_stb_vld[4] +  C8T3_stb_vld[5] +  C8T3_stb_vld[6] +  C8T3_stb_vld[7] ;

reg [4:0] C8T0_stb_vld_sum_d1;
reg [4:0] C8T1_stb_vld_sum_d1;
reg [4:0] C8T2_stb_vld_sum_d1;
reg [4:0] C8T3_stb_vld_sum_d1;

`ifndef RTL_SPU
wire   C8T0_st_ack  = &`SPARC_CORE8.sparc0.lsu.lsu.cpx_st_ack_tid0;
wire   C8T1_st_ack  = &`SPARC_CORE8.sparc0.lsu.lsu.cpx_st_ack_tid1;
wire   C8T2_st_ack  = &`SPARC_CORE8.sparc0.lsu.lsu.cpx_st_ack_tid2;
wire   C8T3_st_ack  = &`SPARC_CORE8.sparc0.lsu.lsu.cpx_st_ack_tid3;

wire   C8T0_defr_trp_en = &`SPARC_CORE8.sparc0.lsu.lsu.excpctl.st_defr_trp_en0;
wire   C8T1_defr_trp_en = &`SPARC_CORE8.sparc0.lsu.lsu.excpctl.st_defr_trp_en1;
wire   C8T2_defr_trp_en = &`SPARC_CORE8.sparc0.lsu.lsu.excpctl.st_defr_trp_en2;
wire   C8T3_defr_trp_en = &`SPARC_CORE8.sparc0.lsu.lsu.excpctl.st_defr_trp_en3;
`else
wire   C8T0_st_ack  = &`SPARC_CORE8.sparc0.lsu.cpx_st_ack_tid0;
wire   C8T1_st_ack  = &`SPARC_CORE8.sparc0.lsu.cpx_st_ack_tid1;
wire   C8T2_st_ack  = &`SPARC_CORE8.sparc0.lsu.cpx_st_ack_tid2;
wire   C8T3_st_ack  = &`SPARC_CORE8.sparc0.lsu.cpx_st_ack_tid3;

wire   C8T0_defr_trp_en	= &`SPARC_CORE8.sparc0.lsu.excpctl.st_defr_trp_en0;
wire   C8T1_defr_trp_en	= &`SPARC_CORE8.sparc0.lsu.excpctl.st_defr_trp_en1;
wire   C8T2_defr_trp_en	= &`SPARC_CORE8.sparc0.lsu.excpctl.st_defr_trp_en2;
wire   C8T3_defr_trp_en	= &`SPARC_CORE8.sparc0.lsu.excpctl.st_defr_trp_en3;
`endif

reg C8T0_defr_trp_en_d1;
reg C8T1_defr_trp_en_d1;
reg C8T2_defr_trp_en_d1;
reg C8T3_defr_trp_en_d1;

integer C8T0_stb_drain_cnt;
integer C8T1_stb_drain_cnt;
integer C8T2_stb_drain_cnt;
integer C8T3_stb_drain_cnt;

// Hits in the store buffer
//-------------------------
`ifndef RTL_SPU
wire       spc8_inst_vld_w      = `SPARC_CORE8.sparc0.ifu.ifu.fcl.inst_vld_w;
wire [1:0] spc8_sas_thrid_w     = `SPARC_CORE8.sparc0.ifu.ifu.fcl.sas_thrid_w[1:0];
`else
wire       spc8_inst_vld_w		= `SPARC_CORE8.sparc0.ifu.fcl.inst_vld_w;
wire [1:0] spc8_sas_thrid_w		= `SPARC_CORE8.sparc0.ifu.fcl.sas_thrid_w[1:0];
`endif

wire C8_st_ack_w = (spc8_sas_thrid_w == 2'b00) & C8T0_st_ack |
                      (spc8_sas_thrid_w == 2'b01) & C8T1_st_ack |
                      (spc8_sas_thrid_w == 2'b10) & C8T2_st_ack |
                      (spc8_sas_thrid_w == 2'b11) & C8T3_st_ack;
...
wire       spc8_stb_cam_hit     = `SPARC_CORE8.sparc0.lsu.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc8_lsu_way_hit     = `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc8_lsu_ifu_ldst_miss_w = `SPARC_CORE8.sparc0.lsu.lsu.lsu_ifu_ldst_miss_w;
wire       spc8_ld_inst_vld_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.ld_inst_vld_g;
wire       spc8_ldst_dbl_g      = `SPARC_CORE8.sparc0.lsu.lsu.dctl.ldst_dbl_g;
wire       spc8_quad_asi_g      = `SPARC_CORE8.sparc0.lsu.lsu.dctl.quad_asi_g;
wire [1:0] spc8_ldst_sz_g       = `SPARC_CORE8.sparc0.lsu.lsu.dctl.ldst_sz_g;
wire       spc8_lsu_alt_space_g = `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_alt_space_g;

wire       spc8_mbar_inst0_g        = `SPARC_CORE8.sparc0.lsu.lsu.dctl.mbar_inst0_g;
wire       spc8_mbar_inst1_g        = `SPARC_CORE8.sparc0.lsu.lsu.dctl.mbar_inst1_g;
wire       spc8_mbar_inst2_g        = `SPARC_CORE8.sparc0.lsu.lsu.dctl.mbar_inst2_g;
wire       spc8_mbar_inst3_g        = `SPARC_CORE8.sparc0.lsu.lsu.dctl.mbar_inst3_g;

wire       spc8_flush_inst0_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.flush_inst0_g;
wire       spc8_flush_inst1_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.flush_inst1_g;
wire       spc8_flush_inst2_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.flush_inst2_g;
wire       spc8_flush_inst3_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.flush_inst3_g;

wire       spc8_intrpt_disp_asi0_g  = `SPARC_CORE8.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b00);
wire       spc8_intrpt_disp_asi1_g  = `SPARC_CORE8.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b01);
wire       spc8_intrpt_disp_asi2_g  = `SPARC_CORE8.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b10);
wire       spc8_intrpt_disp_asi3_g  = `SPARC_CORE8.sparc0.lsu.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b11);

wire       spc8_st_inst_vld_g   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.st_inst_vld_g;
wire       spc8_non_altspace_ldst_g = `SPARC_CORE8.sparc0.lsu.lsu.dctl.non_altspace_ldst_g;

wire       spc8_dctl_flush_pipe_w   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc8_no_spc_rmo_st   = `SPARC_CORE8.sparc0.lsu.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc8_ldst_fp_e       = `SPARC_CORE8.sparc0.lsu.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc8_stb_rdptr       = `SPARC_CORE8.sparc0.lsu.lsu.stb_rwctl.stb_rdptr_l;

wire       spc8_ld_l2cache_req  = `SPARC_CORE8.sparc0.lsu.lsu.qctl1.ld3_l2cache_rq |
                      `SPARC_CORE8.sparc0.lsu.lsu.qctl1.ld2_l2cache_rq |
                              `SPARC_CORE8.sparc0.lsu.lsu.qctl1.ld1_l2cache_rq |
                      `SPARC_CORE8.sparc0.lsu.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc8_dcache_enable   = {`SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_ctl_reg0[1],
                                           `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_ctl_reg1[1],
                       `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_ctl_reg2[1],
                       `SPARC_CORE8.sparc0.lsu.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc8_icache_enable   = `SPARC_CORE8.sparc0.lsu.lsu.lsu_ifu_icache_en[3:0];

wire spc8_dc_direct_map         = `SPARC_CORE8.sparc0.lsu.lsu.dc_direct_map;
wire spc8_lsu_ifu_direct_map_l1 = `SPARC_CORE8.sparc0.lsu.lsu.lsu_ifu_direct_map_l1;
`else
...
wire       spc8_stb_cam_hit		= `SPARC_CORE8.sparc0.lsu.stb_cam_hit;
wire [`L1D_WAY_ARRAY_MASK] spc8_lsu_way_hit		= `SPARC_CORE8.sparc0.lsu.dctl.lsu_way_hit[`L1D_WAY_ARRAY_MASK];
wire       spc8_lsu_ifu_ldst_miss_w	= `SPARC_CORE8.sparc0.lsu.lsu_ifu_ldst_miss_w;
wire       spc8_ld_inst_vld_g	= `SPARC_CORE8.sparc0.lsu.dctl.ld_inst_vld_g;
wire       spc8_ldst_dbl_g		= `SPARC_CORE8.sparc0.lsu.dctl.ldst_dbl_g;
wire       spc8_quad_asi_g		= `SPARC_CORE8.sparc0.lsu.dctl.quad_asi_g;
wire [1:0] spc8_ldst_sz_g		= `SPARC_CORE8.sparc0.lsu.dctl.ldst_sz_g;
wire       spc8_lsu_alt_space_g	= `SPARC_CORE8.sparc0.lsu.dctl.lsu_alt_space_g;

wire       spc8_mbar_inst0_g		= `SPARC_CORE8.sparc0.lsu.dctl.mbar_inst0_g;
wire       spc8_mbar_inst1_g		= `SPARC_CORE8.sparc0.lsu.dctl.mbar_inst1_g;
wire       spc8_mbar_inst2_g		= `SPARC_CORE8.sparc0.lsu.dctl.mbar_inst2_g;
wire       spc8_mbar_inst3_g		= `SPARC_CORE8.sparc0.lsu.dctl.mbar_inst3_g;

wire       spc8_flush_inst0_g	= `SPARC_CORE8.sparc0.lsu.dctl.flush_inst0_g;
wire       spc8_flush_inst1_g	= `SPARC_CORE8.sparc0.lsu.dctl.flush_inst1_g;
wire       spc8_flush_inst2_g	= `SPARC_CORE8.sparc0.lsu.dctl.flush_inst2_g;
wire       spc8_flush_inst3_g	= `SPARC_CORE8.sparc0.lsu.dctl.flush_inst3_g;

wire       spc8_intrpt_disp_asi0_g	= `SPARC_CORE8.sparc0.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b00);
wire       spc8_intrpt_disp_asi1_g	= `SPARC_CORE8.sparc0.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b01);
wire       spc8_intrpt_disp_asi2_g	= `SPARC_CORE8.sparc0.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b10);
wire       spc8_intrpt_disp_asi3_g	= `SPARC_CORE8.sparc0.lsu.dctl.intrpt_disp_asi_g & (spc8_sas_thrid_w == 2'b11);

wire       spc8_st_inst_vld_g	= `SPARC_CORE8.sparc0.lsu.dctl.st_inst_vld_g;
wire       spc8_non_altspace_ldst_g	= `SPARC_CORE8.sparc0.lsu.dctl.non_altspace_ldst_g;

wire       spc8_dctl_flush_pipe_w	= `SPARC_CORE8.sparc0.lsu.dctl.dctl_flush_pipe_w;

wire [3:0] spc8_no_spc_rmo_st	= `SPARC_CORE8.sparc0.lsu.dctl.no_spc_rmo_st[3:0];


wire       spc8_ldst_fp_e		= `SPARC_CORE8.sparc0.lsu.ifu_lsu_ldst_fp_e;
wire [2:0] spc8_stb_rdptr		= `SPARC_CORE8.sparc0.lsu.stb_rwctl.stb_rdptr_l;

wire 	   spc8_ld_l2cache_req 	= `SPARC_CORE8.sparc0.lsu.qctl1.ld3_l2cache_rq |
					  `SPARC_CORE8.sparc0.lsu.qctl1.ld2_l2cache_rq |
                 			  `SPARC_CORE8.sparc0.lsu.qctl1.ld1_l2cache_rq |
					  `SPARC_CORE8.sparc0.lsu.qctl1.ld0_l2cache_rq;

wire [3:0] spc8_dcache_enable	= {`SPARC_CORE8.sparc0.lsu.dctl.lsu_ctl_reg0[1],
                                    	   `SPARC_CORE8.sparc0.lsu.dctl.lsu_ctl_reg1[1],
					   `SPARC_CORE8.sparc0.lsu.dctl.lsu_ctl_reg2[1],
					   `SPARC_CORE8.sparc0.lsu.dctl.lsu_ctl_reg3[1]};

wire [3:0] spc8_icache_enable	= `SPARC_CORE8.sparc0.lsu.lsu_ifu_icache_en[3:0];

wire spc8_dc_direct_map 		= `SPARC_CORE8.sparc0.lsu.dc_direct_map;
wire spc8_lsu_ifu_direct_map_l1	= `SPARC_CORE8.sparc0.lsu.lsu_ifu_direct_map_l1;
`endif

always @(spc8_dcache_enable)
    $display("%0d tso_mon: spc8_dcache_enable changed to %x", $time, spc8_dcache_enable);

always @(spc8_icache_enable)
    $display("%0d tso_mon: spc8_icache_enable changed to %x", $time, spc8_icache_enable);

always @(spc8_dc_direct_map)
    $display("%0d tso_mon: spc8_dc_direct_map changed to %x", $time, spc8_dc_direct_map);

always @(spc8_lsu_ifu_direct_map_l1)
   $display("%0d tso_mon: spc8_lsu_ifu_direct_map_l1 changed to %x", $time, spc8_lsu_ifu_direct_map_l1);

reg 		spc8_dva_svld_e_d1;
reg 		spc8_dva_rvld_e_d1;
reg [`L1D_ADDRESS_HI:4] 	spc8_dva_rd_addr_e_d1;
reg [4:0]  	spc8_dva_snp_addr_e_d1;

reg   		spc8_lsu_snp_after_rd;
reg   		spc8_lsu_rd_after_snp;

reg 	   	spc8_ldst_fp_m, spc8_ldst_fp_g;

integer 	spc8_multiple_hits;

reg spc8_skid_d1, spc8_skid_d2, spc8_skid_d3;
initial begin
  spc8_skid_d1 = 0;
  spc8_skid_d2 = 0;
  spc8_skid_d3 = 0;
...
begin
  ...
  spc8_skid_d1 <= (~spc8_ifu_lsu_inv_clear & spc8_dfq_rd_advance & spc8_dfq_int_type);
  spc8_skid_d2 <= spc8_skid_d1 & ~spc8_ifu_lsu_inv_clear;
  spc8_skid_d3 <= spc8_skid_d2 & ~spc8_ifu_lsu_inv_clear;

// The full tracking of this condition is complicated since after the interrupt is advanced
// there may be more invalidations to the IFQ.
// All we care about is that the invalidations BEFORE the interrupt are finished.
// I provided a command line argument to disable this check.
  if(spc8_skid_d3 & enable_ifu_lsu_inv_clear)
     finish_test("spc", "tso_mon:   spc8_ifu_lsu_inv_clear should have been clear by now", 8);

  spc8_dva_svld_e_d1 	<= spc8_dva_svld_e;
  spc8_dva_rvld_e_d1 	<= spc8_dva_rvld_e;
  spc8_dva_rd_addr_e_d1 	<= spc8_dva_rd_addr_e;
  spc8_dva_snp_addr_e_d1 	<= spc8_dva_snp_addr_e;

  if(spc8_dva_svld_e_d1 & spc8_dva_rvld_e & (spc8_dva_rd_addr_e_d1[`L1D_ADDRESS_HI:6] == spc8_dva_snp_addr_e[4:0]))
    spc8_lsu_rd_after_snp <= 1'b1;
  else
    spc8_lsu_rd_after_snp <= 1'b0;

  if(spc8_dva_svld_e & spc8_dva_rvld_e_d1 & (spc8_dva_rd_addr_e[`L1D_ADDRESS_HI:6] == spc8_dva_snp_addr_e_d1[4:0]))
    spc8_lsu_snp_after_rd <= 1'b1;
  else
    spc8_lsu_snp_after_rd <= 1'b0;

  spc8_ldst_fp_m <= spc8_ldst_fp_e;
  spc8_ldst_fp_g <= spc8_ldst_fp_m;

  if(spc8_stb_data_rptr_vld & spc8_stb_data_wptr_vld & ~spc8_stbrwctl_flush_pipe_w &
     (spc8_stb_data_rd_ptr == spc8_stb_data_wr_ptr) & spc8_lsu_st_pcx_rq_pick)
  begin
    finish_test("spc", "tso_mon: LSU stb data write and read in the same cycle", 8);
  end

   spc8_multiple_hits = (spc8_lsu_way_hit[3] + spc8_lsu_way_hit[2] + spc8_lsu_way_hit[1] + spc8_lsu_way_hit[0]);
   if(!spc8_lsu_ifu_ldst_miss_w && (spc8_multiple_hits >1) && spc8_inst_vld_w && !spc8_dctl_flush_pipe_w && !spc8_lsu_dc_tag_pe_g_unmasked_or)
     finish_test("spc", "tso_mon: LSU multiple hits ", 8);
end

wire spc8_ld_dbl      = spc8_ld_inst_vld_g &  spc8_ldst_dbl_g &  ~spc8_quad_asi_g;
wire spc8_ld_quad     = spc8_ld_inst_vld_g &  spc8_ldst_dbl_g &  spc8_quad_asi_g;
wire spc8_ld_other    = spc8_ld_inst_vld_g & ~spc8_ldst_dbl_g;

wire spc8_ld_dbl_fp   = spc8_ld_dbl        &  spc8_ldst_fp_g;
wire spc8_ld_other_fp = spc8_ld_other      &  spc8_ldst_fp_g;

wire spc8_ld_dbl_int  = spc8_ld_dbl        & ~spc8_ldst_fp_g;
wire spc8_ld_quad_int = spc8_ld_quad       & ~spc8_ldst_fp_g;
wire spc8_ld_other_int= spc8_ld_other      & ~spc8_ldst_fp_g;

wire spc8_ld_bypassok_hit = |spc8_stb_ld_full_raw[7:0] & ~spc8_stb_cam_mhit;
wire spc8_ld_partial_hit  = |spc8_stb_ld_partial_raw[7:0] & ~spc8_stb_cam_mhit;
wire spc8_ld_multiple_hit =  spc8_stb_cam_mhit;

wire spc8_any_lsu_way_hit = |spc8_lsu_way_hit;

wire [7:0] spc8_stb_rdptr_decoded = 	(spc8_stb_rdptr ==3'b000) ? 8'b00000001 :
                               		(spc8_stb_rdptr ==3'b001) ? 8'b00000010 :
                               		(spc8_stb_rdptr ==3'b010) ? 8'b00000100 :
                              		(spc8_stb_rdptr ==3'b011) ? 8'b00001000 :
                              		(spc8_stb_rdptr ==3'b100) ? 8'b00010000 :
                              		(spc8_stb_rdptr ==3'b101) ? 8'b00100000 :
                             		(spc8_stb_rdptr ==3'b110) ? 8'b01000000 :
                              		(spc8_stb_rdptr ==3'b111) ? 8'b10000000 : 8'h00;


wire spc8_stb_top_hit = |(spc8_stb_rdptr_decoded & (spc8_stb_ld_full_raw | spc8_stb_ld_partial_raw));

//---------------------------------------------------------------------
// ld_type[4:0] hit_type[2:0], cache_hit, hit_top
// this is passed to the coverage monitor.
//---------------------------------------------------------------------
wire [10:0] spc8_stb_ld_hit_info =
	{spc8_ld_dbl_fp,        spc8_ld_other_fp,
	 spc8_ld_dbl_int, 	   spc8_ld_quad_int,    spc8_ld_other_int,
	 spc8_ld_bypassok_hit,  spc8_ld_partial_hit, spc8_ld_multiple_hit,
	 spc8_any_lsu_way_hit,
	 spc8_stb_top_hit, C8_st_ack_w};

reg spc8_mbar0_active;
reg spc8_mbar1_active;
reg spc8_mbar2_active;
reg spc8_mbar3_active;

reg spc8_flush0_active;
reg spc8_flush1_active;
reg spc8_flush2_active;
reg spc8_flush3_active;

reg spc8_intr0_active;
reg spc8_intr1_active;
reg spc8_intr2_active;
reg spc8_intr3_active;

always @(negedge clk)
begin
  if(~rst_l)
  begin
     spc8_mbar0_active <= 1'b0;
     spc8_mbar1_active <= 1'b0;
     spc8_mbar2_active <= 1'b0;
     spc8_mbar3_active <= 1'b0;

     spc8_flush0_active <= 1'b0;
     spc8_flush1_active <= 1'b0;
     spc8_flush2_active <= 1'b0;
     spc8_flush3_active <= 1'b0;

     spc8_intr0_active <= 1'b0;
     spc8_intr1_active <= 1'b0;
     spc8_intr2_active <= 1'b0;
     spc8_intr3_active <= 1'b0;

  end
  else
  begin
    if(spc8_mbar_inst0_g & ~spc8_dctl_flush_pipe_w & (C8T0_stb_ne|~spc8_no_spc_rmo_st[0]))
	spc8_mbar0_active <= 1'b1;
    else if(~C8T0_stb_ne & spc8_no_spc_rmo_st[0])
	spc8_mbar0_active <= 1'b0;
    if(spc8_mbar_inst1_g & ~ spc8_dctl_flush_pipe_w & (C8T1_stb_ne|~spc8_no_spc_rmo_st[1]))
	spc8_mbar1_active <= 1'b1;
    else if(~C8T1_stb_ne & spc8_no_spc_rmo_st[1])
	spc8_mbar1_active <= 1'b0;
    if(spc8_mbar_inst2_g & ~ spc8_dctl_flush_pipe_w & (C8T2_stb_ne|~spc8_no_spc_rmo_st[2]))
	spc8_mbar2_active <= 1'b1;
    else if(~C8T2_stb_ne & spc8_no_spc_rmo_st[2])
	spc8_mbar2_active <= 1'b0;
    if(spc8_mbar_inst3_g & ~ spc8_dctl_flush_pipe_w & (C8T3_stb_ne|~spc8_no_spc_rmo_st[3]))
	spc8_mbar3_active <= 1'b1;
    else if(~C8T3_stb_ne & spc8_no_spc_rmo_st[3])
	spc8_mbar3_active <= 1'b0;

    if(spc8_flush_inst0_g & ~spc8_dctl_flush_pipe_w & C8T0_stb_ne) 	spc8_flush0_active <= 1'b1;
    else if(~C8T0_stb_ne)			  				spc8_flush0_active <= 1'b0;
    if(spc8_flush_inst1_g & ~spc8_dctl_flush_pipe_w & C8T1_stb_ne) 	spc8_flush1_active <= 1'b1;
    else if(~C8T1_stb_ne)			  				spc8_flush1_active <= 1'b0;
    if(spc8_flush_inst2_g & ~spc8_dctl_flush_pipe_w & C8T2_stb_ne) 	spc8_flush2_active <= 1'b1;
    else if(~C8T2_stb_ne)			  				spc8_flush2_active <= 1'b0;
    if(spc8_flush_inst3_g & ~spc8_dctl_flush_pipe_w & C8T3_stb_ne) 	spc8_flush3_active <= 1'b1;
    else if(~C8T3_stb_ne)			  				spc8_flush3_active <= 1'b0;

    if(spc8_intrpt_disp_asi0_g & spc8_st_inst_vld_g & ~spc8_non_altspace_ldst_g & ~spc8_dctl_flush_pipe_w & C8T0_stb_ne)
	spc8_intr0_active <= 1'b1;
    else if(~C8T0_stb_ne)
	spc8_intr0_active <= 1'b0;
    if(spc8_intrpt_disp_asi1_g &  spc8_st_inst_vld_g & ~spc8_non_altspace_ldst_g & ~spc8_dctl_flush_pipe_w & C8T1_stb_ne)
	spc8_intr1_active <= 1'b1;
    else if(~C8T1_stb_ne)
	spc8_intr1_active <= 1'b0;
    if(spc8_intrpt_disp_asi2_g &  spc8_st_inst_vld_g & ~spc8_non_altspace_ldst_g & ~spc8_dctl_flush_pipe_w & C8T2_stb_ne)
	spc8_intr2_active <= 1'b1;
    else if(~C8T2_stb_ne)
	spc8_intr2_active <= 1'b0;
    if(spc8_intrpt_disp_asi3_g &  spc8_st_inst_vld_g & ~spc8_non_altspace_ldst_g & ~spc8_dctl_flush_pipe_w & C8T3_stb_ne)
	spc8_intr3_active <= 1'b1;
    else if(~C8T3_stb_ne)
	spc8_intr3_active <= 1'b0;
  end

  if(spc8_mbar0_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b00)
    finish_test("spc", "membar violation thread 0", 8);
  if(spc8_mbar1_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b01)
    finish_test("spc", "membar violation thread 1", 8);
  if(spc8_mbar2_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b10)
    finish_test("spc", "membar violation thread 2", 8);
  if(spc8_mbar3_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b11)
    finish_test("spc", "membar violation thread 3", 8);

  if(spc8_flush0_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b00)
    finish_test("spc", "flush violation thread 0", 8);
  if(spc8_flush1_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b01)
    finish_test("spc", "flush violation thread 1", 8);
  if(spc8_flush2_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b10)
    finish_test("spc", "flush violation thread 2", 8);
  if(spc8_flush3_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b11)
    finish_test("spc", "flush violation thread 3", 8);

  if(spc8_intr0_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b00)
    finish_test("spc", "intr violation thread 0", 8);
  if(spc8_intr1_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b01)
    finish_test("spc", "intr violation thread 1", 8);
  if(spc8_intr2_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b10)
    finish_test("spc", "intr violation thread 2", 8);
  if(spc8_intr3_active & spc8_inst_vld_w & spc8_sas_thrid_w[1:0] == 2'b11)
    finish_test("spc", "intr violation thread 3", 8);

   else							C8T0_stb_drain_cnt = C8T0_stb_drain_cnt + 1;
   if(C8T0_stb_drain_cnt > stb_drain_to_max)
     finish_test("spc", "stb 0 is not draining", 8);

   else							C8T1_stb_drain_cnt = C8T1_stb_drain_cnt + 1;
   if(C8T1_stb_drain_cnt > stb_drain_to_max)
     finish_test("spc", "stb 1 is not draining", 8);

   else							C8T2_stb_drain_cnt = C8T2_stb_drain_cnt + 1;
   if(C8T2_stb_drain_cnt > stb_drain_to_max)
     finish_test("spc", "stb 2 is not draining", 8);

   else							C8T3_stb_drain_cnt = C8T3_stb_drain_cnt + 1;
   if(C8T3_stb_drain_cnt > stb_drain_to_max)
     finish_test("spc", "stb 3 is not draining", 8);

  C8T0_stb_vld_sum_d1 <= C8T0_stb_vld_sum;
  C8T1_stb_vld_sum_d1 <= C8T1_stb_vld_sum;
  C8T2_stb_vld_sum_d1 <= C8T2_stb_vld_sum;
  C8T3_stb_vld_sum_d1 <= C8T3_stb_vld_sum;
  C8T0_defr_trp_en_d1 <= C8T0_defr_trp_en;
  C8T1_defr_trp_en_d1 <= C8T1_defr_trp_en;
  C8T2_defr_trp_en_d1 <= C8T2_defr_trp_en;
  C8T3_defr_trp_en_d1 <= C8T3_defr_trp_en;

  if(rst_l & C8T0_defr_trp_en_d1 & (C8T0_stb_vld_sum_d1 < C8T0_stb_vld_sum))
     finish_test("spc", "tso_mon: deferred trap problems for store T0", 8);
  if(rst_l & C8T1_defr_trp_en_d1 & (C8T1_stb_vld_sum_d1 < C8T1_stb_vld_sum))
     finish_test("spc", "tso_mon: deferred trap problems for store T1", 8);
  if(rst_l & C8T2_defr_trp_en_d1 & (C8T2_stb_vld_sum_d1 < C8T2_stb_vld_sum))
     finish_test("spc", "tso_mon: deferred trap problems for store T2", 8);
  if(rst_l & C8T3_defr_trp_en_d1 & (C8T3_stb_vld_sum_d1 < C8T3_stb_vld_sum))
     finish_test("spc", "tso_mon: deferred trap problems for store T3", 8);
...
`ifndef RTL_SPU
      force `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`else
...
`ifndef RTL_SPU
      release `SPARC_CORE4.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
`else
...
`ifndef RTL_SPU
      force `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`else
...
`ifndef RTL_SPU
      release `SPARC_CORE5.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
`else
...
`ifndef RTL_SPU
      force `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`else
...
`ifndef RTL_SPU
      release `SPARC_CORE6.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
`else
...
`ifndef RTL_SPU
      force `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`else
...
`ifndef RTL_SPU
      release `SPARC_CORE7.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
`else
...
`ifdef RTL_SPARC8
reg [1:0] spc8_dfq_fsm1;
integer  spc8_dfq_forced;
...
begin
  if(~rst_l)
  begin
    cpx_spc8_data_cx2_d2  <= `CPX_WIDTH'b0;
    cpx_spc8_data_cx2_d1  <= `CPX_WIDTH'b0;
    spc8_dfq_byp_ff_en_d1 <= 1'b0;
    spc8_dfq_wr_en_d1     <= 1'b0;
    spc8_dfq_fsm1	     <= 2'b00;
    spc8_dfq_forced       <= 0;
  ...
  begin
    ...
    cpx_spc8_data_cx2_d2  <= cpx_spc8_data_cx2_d1;
    cpx_spc8_data_cx2_d1  <= cpx_spc8_data_cx2;
    spc8_dfq_byp_ff_en_d1 <= spc8_dfq_byp_ff_en;
    spc8_dfq_wr_en_d1     <= spc8_dfq_wr_en;

    if(cpx_spc8_data_cx2_d2[144] & (cpx_spc8_data_cx2_d2[143:140] == 4'h1) & ~cpx_spc8_data_cx2_d2[133] &
       cpx_spc8_data_cx2_d1[144] & (cpx_spc8_data_cx2_d1[143:140] == 4'h1) &  cpx_spc8_data_cx2_d1[133])
    begin
      $display("%0d: spc%0d tso_mon:condition1 for bug6362\n", $time, 8);
      if(spc8_dfq_wr_en & ~spc8_dfq_wr_en_d1 & ~spc8_dfq_byp_ff_en)
      begin
        $display("%0d: spc%0d tso_mon:condition2 for bug6362\n", $time, 8);

        if(spc8_dfq_fsm1 == 2'b00)
          spc8_dfq_fsm1 <= 2'b01;
        else
          finish_test("spc", "tso_mon:something is wrong with dfq_fsm1", 8);

        if(kill_on_cross_mod_code)
          finish_test("spc", "tso_mon:condition2 for bug6362", 8);
      end
    end

    if((spc8_dfq_fsm1 == 2'b01) & spc8_lsu_ifill_pkt_vld & spc8_dfq_rd_advance)
    begin
      spc8_dfq_fsm1 <= 2'b00;	// IDLE
    end
    else if((spc8_dfq_fsm1 == 2'b01) & spc8_lsu_ifill_pkt_vld & ~spc8_dfq_rd_advance)
    begin
      spc8_dfq_fsm1 <= 2'b10;	// UNFINISHED HANDSHAKE
    end
    else if((spc8_dfq_fsm1 == 2'b10) & spc8_lsu_ifill_pkt_vld & spc8_dfq_rd_advance)
    begin
      spc8_dfq_fsm1 <= 2'b00;
    end
    else if((spc8_dfq_fsm1 == 2'b10) & ~spc8_lsu_ifill_pkt_vld)
    begin
          finish_test("spc", "tso_mon:bug6362 hit - ifill_pkt goes out BEFORE dfq_rd_advance", 8);
    end

    if(force_dfq & ~spc8_dfq_byp_ff_en & (spc8_dfq_forced == 0))
    begin
      $display("%0d: spc%0d forcing spc8_dfq_forced\n", $time, 8);
`ifndef RTL_SPU
      force `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`else
      force `SPARC_CORE8.sparc0.lsu.qctl2.dfq_byp_ff_en = 1'b0;
`endif
      spc8_dfq_forced = 1;
    end
    else if((spc8_dfq_forced >0) && (spc8_dfq_forced <10))
         spc8_dfq_forced =  spc8_dfq_forced + 1;
    else if(spc8_dfq_forced !=0)
    begin
      $display("%0d: spc%0d releasing spc8_dfq_forced\n", $time, 8);
`ifndef RTL_SPU
      release `SPARC_CORE8.sparc0.lsu.lsu.qctl2.dfq_byp_ff_en;
`else
      release `SPARC_CORE8.sparc0.lsu.qctl2.dfq_byp_ff_en;
`endif
      spc8_dfq_forced  = 0;
    end
